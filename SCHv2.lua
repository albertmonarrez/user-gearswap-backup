...
function init_gear_sets()
	...
	local nuke_set={
		...
		head={ name="Merlinic Hood", augments={'Mag. Acc.+22 "Mag.Atk.Bns."+22','"Drain" and "Aspir" potency +5','"Mag.Atk.Bns."+9',}},
	...
	local idle_set=set_combine(nuke_set,{
	...
	local burst_set=set_combine(nuke_set,{
		...
		left_ear="Barkaro. Earring",
		legs={ name="Merlinic Shalwar", augments={'Accuracy+8','Magic burst dmg.+10%','CHR+7','Mag. Acc.+4','"Mag.Atk.Bns."+9',}},
		feet="Jhakri Pigaches +2",
	})
	local klimaform_burst={left_ear="Static Earring"}
	...
	--Enfeebling set
	local enfeebling_set={head="Aya. Zucchetto +1",
		ammo="Hydrocera",
	...
	--Cure set
	local cure_set={ear1="Mendicant's earring",
		left_ring="Vocane Ring",
	...
	sets.midcast.CureWeather = cure_set
	
	sets.midcast.Curaga = cure_set
	...
	sets.midcast.Regen = {body={ name="Telchine Chas.", augments={'"Regen" potency+2',}}, head="Arbatel Bonnet"}
	
	sets.midcast.RegenDuration = {body={ name="Telchine Chas.", augments={'"Regen" potency+2',}}, head="Arbatel Bonnet"}
	...
	sets.midcast.DarkHelix = low_tier_set
	sets.midcast.LightHelix = low_tier_set
	...
	sets.magic_burst = magic_burst

	sets.magic_burst.Resistant = magic_burst
