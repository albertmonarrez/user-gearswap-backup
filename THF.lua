...
--[[
    ...
    gs c cycle treasuremode (set on ctrl-= by default): Cycles through the available - hunter modes.
...
function init_gear_sets()
    ...
    local tp_set = {
        ...
        right_ear = inv.skulkers_earring,
        left_ring = inv.gere_ring,
        right_ring = inv.eponas_ring,
        back = inv.null_shawl,
    }
    ...
    sets.precast.JA['Flee'] = { feet = inv.pillagers_feet }
    sets.precast.JA['Hide'] = { body = inv.pillagers_vest }
    ...
    sets.precast.FC = {
        ...
        head = { name = "Herculean Helm", augments = { '"Triple Atk."+4', 'STR+2', 'Accuracy+15', 'Attack+12', } },
        body = "Dread Jupon",
        hands = { name = "Leyline Gloves", augments = { 'Accuracy+15', 'Mag. Acc.+15', '"Mag.Atk.Bns."+15', '"Fast Cast"+3', } },
        feet = { name = "Taeon Boots", augments = { '"Fast Cast"+1', '"Regen" potency+2', } },
    ...
    sets.precast.WS['Evisceration'] = evisceration
    ...
    sets.precast.WS["Rudra's Storm"] = rudras_storm
    sets.precast.WS["Rudra's Storm"].Acc = set_combine(rudras_storm,
        { ammo = "Honed Tathlum", back = "Letalis Mantle" })
    sets.precast.WS["Rudra's Storm"].Mod = set_combine(rudras_storm,
        { back = "Kayapa Cape", waist = gear.ElementalBelt })
    sets.precast.WS["Rudra's Storm"].SA = set_combine(rudras_storm, {
        -- ammo = "Qirmiz Tathlum",
        body = inv.pillagers_vest,
        -- legs = "Pillager's Culottes +1"
    })
    sets.precast.WS["Rudra's Storm"].TA = set_combine(rudras_storm, {
        -- ammo = "Qirmiz Tathlum",
        body = inv.pillagers_vest,
        -- legs = "Pillager's Culottes +1"
    })
    sets.precast.WS["Rudra's Storm"].SATA = set_combine(rudras_storm, {
        -- ammo = "Qirmiz Tathlum",
        body = inv.pillagers_vest,
        -- legs = "Pillager's Culottes +1"
    })
    ...
    sets.precast.WS["Shark Bite"] = set_combine(sets.precast.WS,
        { head = "Pillager's Bonnet +1", ear1 = "Brutal Earring", ear2 = "Moonshade Earring" })
