...
return {
    ...
    Geomancy_Galero      = "Geomancy Galero",
    ...
    Geomancy_Mitaines    = "Geomancy Mitaines",
    ...
    Nantosuelta_Cape_Pet = { name = "Nantosuelta's Cape", augments = { 'HP+30', 'Eva.+10 /Mag. Eva.+10', 'Pet: "Regen"+10', } },
    ...
    -- Legs
    Bagua_Pants          = { name = "Bagua Pants", augments = { 'Enhances "Mending Halation" effect', } },
    Vanya_Slops          = { name = "Vanya Slops", augments = { 'MP+50', '"Cure" potency +7%', 'Enmity-6', } },
    Geomancy_Pants       = "Geomancy Pants",
    ...
    Bagua_Sandals        = { name = "Bagua Sandals", augments = { 'Enhances "Radial Arcana" effect', } },
    Vanya_Clogs          = { name = "Vanya Clogs", augments = { 'MP+50', '"Cure" potency +7%', 'Enmity-6', } },
    Geomancy_Sandals     = "Geomancy Sandals",
