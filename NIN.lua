...
function init_gear_sets()
    ...
    sets.precast.WS['Blade: Hi'] = set_combine(sets.precast.WS, {
        ...
        waist = "Sailfi Belt +1",
        ear1 = inv.odr_earring,
        ear2 = inv.ishvara,
        left_ring = "Begrudging Ring",
        right_ring = "Cornelia's Ring",
        back = inv.NIN_WSD_Cape,
    })
    ...
    sets.precast.WS['Blade: Shun'].Acc = set_combine(sets.precast.WS['Blade: Shun'], {
        ...
        legs = { name = "Herculean Trousers", augments = { 'Accuracy+21', '"Triple Atk."+4', 'DEX+8', } },
        feet = "Mummu Gamash. +2",
        neck = "Light Gorget",
        waist = "Light Belt",
        ...
        back = { name = "Mecisto. Mantle", augments = { 'Cap. Point+31%', 'MP+17', 'DEF+12', } },
    })
    ...
    sets.precast.WS['Blade: Yu'] = set_combine(sets.precast.WS, {
        ...
        legs = inv.Herc_WS_legs,
        feet = inv.Herc_MAB_feet,
        neck = "Baetyl Pendant",
    ...
    sets.NightMovement = { feet = inv.hachiya_feet }
    ...
    sets.engaged.MidHaste = {
        ...
        hands = { name = "Adhemar Wristbands", augments = { 'DEX+10', 'AGI+10', 'Accuracy+15', } },
        legs = { name = "Herculean Trousers", augments = { 'Accuracy+21', '"Triple Atk."+4', 'DEX+8', } },
        feet = { name = "Herculean Boots", augments = { 'Accuracy+21', '"Triple Atk."+4', 'Attack+12', } },
    ...
    sets.engaged.Hybrid = {
        ...
        legs = inv.malignance_tights,  --7/7
    ...
    sets.Tanking = { main = "Fudo Masamune", sub = "Gleti's Knife", }
end
