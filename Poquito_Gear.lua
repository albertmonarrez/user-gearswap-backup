...
return {
    ...
    Brioso_Roundlet    = "Brioso Roundlet",
    ...
    -- Body
    Fili_Hongreline    = "Fili Hongreline",
    ...
    -- Hands
    Fili_Manchettes    = "Fili Manchettes",
    ...
    Sailfi_Belt        = "Sailfi Belt",

    -- Legs
    Fili_Rhingrave     = "Fili Rhingrave",
    ...
    Brioso_Cannions    = "Brioso Cannions",
