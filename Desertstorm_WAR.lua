...
function init_gear_sets()
    ...
    sets.precast.JA['Mighty Strikes'] = set_combine(sets.precast.JA, { hands = inv.agoge_hands })
    sets.precast.JA['Defender'] = set_combine(sets.precast.JA, { hands = inv.agoge_hands })
